...
class TOUR {
    String place,hotel,mode,d;
    int hotel_charge=0,ticketcost=0,nights;
    Date date=null;
    ...
    void show_places(){
        ...
        int sc1,sc2,sc;
        int nights;
        String s_place,s_hotel,s_mode,s_food;
...
System.out.println("Hotelcharge::"+hotel_charge);
    ...
    void show_detail(int cid){
        System.out.println("Place:::"+place);
        System.out.println("Hotel:::"+hotel);
        System.out.println("Mode of travel:::"+mode);
        System.out.println("Total_Cost:::"+(hotel_charge+ticketcost));
...
abstract class LOGIN{
    String name="NULL",pass="NULL",email="NULL",username="NULL", adno="NULL";
    
    int cid;
    abstract void fsignin(int cid);
    ...
    void flogin(int cid){
            ...
            if(usrname==username||usrpass==pass){
